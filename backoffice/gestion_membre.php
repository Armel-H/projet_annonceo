...
foreach ($membres as $valeur) { // parcourt tous les enregistrement
   $contenu .= "<tr>"; // ligne pour chaque enregistrement
       ...
       $contenu .= '<td><a href="?action=modification&id_membre='. $valeur['id_membre'] .'"><img src="../img/edit.png"></a></td>';
       $contenu .= '<td><a onclick="confirm(\'Etes-vous certain de vouloir supprimer ce  membre' . $valeur['id_membre'] . '\');" href="supprimer_membre.php?id=' . $valeur['id_membre'] . '"><img src="../img/delete.png"></a></td>';
